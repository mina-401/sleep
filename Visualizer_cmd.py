...
def plot_q2_panels(q2_result: dict):
    ...
    plt.tight_layout()
    plt.savefig("output/q2_panels.png", dpi=150, bbox_inches="tight")
    print("[저장] output/q2_panels.png")
    plt.show()
...
def plot_q2_heatmap(df: pd.DataFrame):
    ...
    plt.tight_layout()
    plt.savefig("output/q2_heatmap.png", dpi=150, bbox_inches="tight")
    print("[저장] output/q2_heatmap.png")
    plt.show()
